      ...
      <section className="max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-xl text-gray-600 mb-10">
            CloseFlow AI instantly responds to inquiries, follows up for
            months, and books showings automatically so agents close more
            deals.
          </p>
          ...
          {!submitted ? (
            ...
            >
              ...
              <button
                type="submit"
                className="bg-black text-white px-6 py-4 rounded-lg font-semibold hover:opacity-90"
              >
                Join Waitlist
              </button>
            </form>
